    ...
    case TeamJoin(user: User) => responder ! PrivateResponse(
     // s"Hey ${user.name} and welcome to our community!",
      """Привет!
        ...
        |Описание каналов:
        |
        |#upwork - для конструктивных вопросов, обсуждений и обмена опытом касательно клиентов и фриланса.
        |#newbie - вопросы новичков на фрилансе или на апворке.
        |#upwork-pride - здесь можно излить душу про дубовую техподдержку, корявый дизайн и косой функционал апворка. Все то что наболело, но на конструктивное обсуждение уже не тянет.
        ...
        |#tech - технологии, операционные системы, разнообразный хардварь.
        ...
        |#money - вопросы, касающиеся обналичивания заработанных кровных. Способы вывода, инвестиции, и ловкое уклонение от налогов и товарища майора - все здесь (и ежедневное обсуждение курса рубля и нефти, конечно).
        |#legal - игра с государством по его правилам. Открытие ИП, легализация доходов, патенты и договора. В каком банке лучше держать расчетный счет.
        |#pol - полемика про политику, правильные режимы, “рашка загнила/встаёт с колен” и прочие схожие темы *только здесь*.
        |#fit - от гедонизма в еде и алкогольных возлияний до правильного режима, тренажерного зала, турников и диеты.
